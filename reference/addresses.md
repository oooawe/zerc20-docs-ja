...
Internet Computer 上で暗号化アナウンスの配信と鍵導出を行うステルスメッセージングレイヤーです。

- **Key Manager** — 受信者がステルスペイロードを復号できるよう、VetKD を通じて IBE（Identity-Based Encryption）鍵を導出します
- **Storage** — 暗号化されたアナウンスと署名済み Invoice を保管します
