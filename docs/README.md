...
{% hint style="info" %}
本ドキュメントは理解促進を目的とし [zERC20公式ドキュメント](https://zerc20.gitbook.io/) を翻訳したものです\
...
| 📅         | ⛏️              | 📃             |
| ---------- | --------------- | -------------- |
| 2026年2月22日 | β公開         | 翻訳 ver: 0.0.3β |
| 2026年2月23日 | 外部リンク加筆         |                |
| 2026年2月26日 | 検索機能追加          |                |
| 2026年2月26日 | 日本語翻訳指示/ニュアンス修正 | 翻訳 ver: 0.0.4β |
| 2026年3月01日 | GitBookに移行       | 翻訳 ver: 0.1.0  |
| 2026年3月15日 | SDK > LayerZero Scan 追加| 翻訳ポリシー同時更新  |

</details>

<div align="center"><img src="./assets/common/ztypograp.svg" alt="" width="70%" height="auto"></div>
...
zERC20 は原資産トークン（USDC、ETH、BNB など）に1:1でバックされたWrapper トークン（Wrapper Token）です。以下の方法で入手できます：
